...
const translations = {
  de: {
    skip: "Zum Inhalt springen", menu: "Menü", homeLabel: "EVE-X-Preview Reloaded Startseite", navLabel: "Hauptnavigation", navFeatures: "Funktionen", navSetup: "Anleitung", navUpdates: "Neuigkeiten", navRoadmap: "Roadmap", navSupport: "Support",
    ...
    realGui: "Echte Programmoberfläche", globalScreenshotAlt: "Allgemeine Einstellungen von EVE-X-Preview Reloaded", globalScreenshotLink: "Screenshot der allgemeinen Einstellungen vergrößern", globalScreenshotCaption: "Allgemeine Einstellungen – echte Aufnahme der aktuellen Windows-Version.",
    ...
    f1Title: "Live-Thumbnails", f1Text: "Alle laufenden EVE-Clients als frei positionierbare Vorschauen – inklusive Name, Rahmen und eigener Größe.", f2Title: "Sofortiger Wechsel", f2Text: "Ein Klick oder frei gewählter Tastatur- und Maus-Hotkey bringt den gewünschten Client nach vorn.", f3Title: "Flexible Profile", f3Text: "Getrennte Anordnungen, Hotkeys und Farben für Mining, Produktion, Flotte oder jeden anderen Einsatz.", f4Title: "Farben mit System", f4Text: "Windows-Farbpalette, HEX- und RGB-Eingabe für Text, aktive Clients und individuelle Charakterrahmen.", f5Title: "Layout-Schutz", f5Text: "Sperre Position und Größe pro Profil, damit ein versehentlicher Rechtsklick dein Layout nicht verschiebt.", f6Title: "Drei Designs · DE/EN", f6Text: "Wähle sofort zwischen Klassisch, Modern Dunkel und Modern Hell – jeweils auf Deutsch oder Englisch.",
    interfaceKicker: "ECHTE OBERFLÄCHE", interfaceTitle: "So sieht das Tool<br><span>wirklich aus.</span>", interfaceLead: "Keine Konzeptgrafik: Die Aufnahmen stammen direkt aus der aktuellen, unter Windows gestarteten Anwendung.", capturedOnWindows: "AUF WINDOWS AUFGENOMMEN", profileScreenshotTitle: "Profile gezielt konfigurieren", profileScreenshotText: "Lege pro Profil fest, welche Clients beim Wechsel minimiert oder maximiert werden. Für die Aufnahme wurde ausschließlich das neutrale Demo-Profil verwendet.", openScreenshot: "Screenshot in Originalgröße öffnen", profileSettings: "Profileinstellungen", profileScreenshotAlt: "Profileinstellungen mit neutralem Demo-Profil", profileScreenshotLink: "Screenshot der Profileinstellungen vergrößern", profileScreenshotCaption: "Profileinstellungen – echte Aufnahme mit neutralen Beispieldaten.",
  ...
  en: {
    skip: "Skip to content", menu: "Menu", homeLabel: "EVE-X-Preview Reloaded home", navLabel: "Main navigation", navFeatures: "Features", navSetup: "Guide", navUpdates: "What's new", navRoadmap: "Roadmap", navSupport: "Support",
    ...
    realGui: "Actual application interface", globalScreenshotAlt: "General settings in EVE-X-Preview Reloaded", globalScreenshotLink: "Enlarge the general settings screenshot", globalScreenshotCaption: "General settings – an actual capture of the current Windows version.",
    ...
    f1Title: "Live thumbnails", f1Text: "Every running EVE client as a freely positioned preview, including character name, border and custom size.", f2Title: "Instant switching", f2Text: "One click or a freely chosen keyboard or mouse hotkey brings the intended client to the front.", f3Title: "Flexible profiles", f3Text: "Separate layouts, hotkeys and colors for mining, industry, fleets or any other activity.", f4Title: "Color control", f4Text: "Windows color palette plus HEX and RGB entry for text, active clients and character-specific borders.", f5Title: "Layout protection", f5Text: "Lock position and size per profile so an accidental right-click cannot move your layout.", f6Title: "Three designs · DE/EN", f6Text: "Switch instantly between Classic, Modern Dark and Modern Light in German or English.",
    interfaceKicker: "ACTUAL INTERFACE", interfaceTitle: "What the tool<br><span>really looks like.</span>", interfaceLead: "No concept artwork: these captures come directly from the current application running on Windows.", capturedOnWindows: "CAPTURED ON WINDOWS", profileScreenshotTitle: "Configure profiles precisely", profileScreenshotText: "Choose per profile which clients should be minimized or maximized when switching. Only the neutral Demo profile was used for this capture.", openScreenshot: "Open screenshot at full size", profileSettings: "Profile settings", profileScreenshotAlt: "Profile settings with a neutral Demo profile", profileScreenshotLink: "Enlarge the profile settings screenshot", profileScreenshotCaption: "Profile settings – an actual capture with neutral sample data.",
